...
def teacher_contract(request, pk):
	...
	default_terms = (
		...
		'    11.  مدت این قرار داد نه ماه بوده از ماه حمل الی ماه قوس 1403، بعد از مدت معینه، در صورت درست انجام دادن وظیفه محوله دوباره تمدید می گردد.\n'
